...
#define UPDATE_ICON_TEXT_NUM_CH                     2
#define UPDATE_ICON_TEXT_NUM_EN                     17
#define MACHINE_START_UP_PAGE                       0
#define SAME_FIRMWARE_ICON_NUM_CH                   23
#define SAME_FIRMWARE_ICON_NUM_EN                   51
#define UPDATE_PAGE_NUM                             35
#define UPDATE_FAILE_PAGE_CH                        29
#define UPDATE_FAILE_PAGE_EN                        95
#define UPDATE_SUCCESS_PAGE_CH                      30
#define UPDATE_SUCCESS_PAGE_EN                      96
...
#define EXCEPTION_SURE_HINT_PAGE_CH                 62
#define EXCEPTION_SURE_HINT_PAGE_EN                 122
